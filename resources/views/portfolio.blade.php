        ...
        <div class="flex flex-col-reverse md:flex-row items-center gap-12">
            ...
            <div class="w-full md:w-1/2 gs-reveal-up mt-12 md:mt-0">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <button onclick="openCvModal()" class="px-8 py-3.5 rounded-full bg-white border border-slate-300 text-slate-700 font-bold hover:border-indigo-400 hover:text-indigo-600 shadow-sm hover:shadow-md transition-all flex items-center gap-2 cursor-pointer">
                        <svg class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
...
<div id="cvModal" class="fixed inset-0 hidden overflow-y-auto" style="z-index: 999999 !important;">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-10" onclick="closeCvModal()">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-slate-200 mb-8 sticky -top-6 bg-white/95 backdrop-blur-sm z-20 gap-4 py-2">
            <div>
                <span class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full uppercase tracking-wider border border-indigo-200">Official Resume</span>
                <h2 class="text-2xl md:text-3xl font-black text-slate-900 mt-1">CHRIS TEPER FERDIYANTO</h2>
            </div>
            <div class="flex items-center gap-3 self-end sm:self-auto">
                <a href="https://drive.google.com/drive/folders/1jDHvvCxNlffiIC0-Napk9JMO77F5cjl6?usp=sharing" target="_blank" class="px-4 py-2 bg-indigo-600 text-white font-bold text-sm rounded-xl hover:bg-indigo-700 transition-all flex items-center gap-2 shadow-sm" title="Unduh arsip dari Google Drive jika dibutuhkan">
        ...
        <div class="mb-10">
            <h3 class="text-base md:text-lg font-extrabold text-slate-900 border-l-4 border-indigo-600 pl-3.5 uppercase tracking-wider mb-6">PROFESSIONAL EXPERIENCE</h3>
            
            <!-- Exp 1 -->
            <div class="border-l-2 border-indigo-500 pl-5 md:pl-6 pb-6 mb-6 border-b border-slate-100">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-1 mb-2">
                    ...
                    <span class="text-xs md:text-sm font-bold text-indigo-700 bg-indigo-50 px-3 py-1 rounded-full border border-indigo-200 w-max">(Sep 2023 – Jun 2025)</span>
                </div>
                <p class="text-sm font-semibold text-indigo-600 mb-3">Yogyakarta, Indonesia</p>
            ...
            <!-- Exp 2 -->
            <div class="border-l-2 border-indigo-500 pl-5 md:pl-6 pb-2">
        ...
        <!-- SKILLS -->
        <div>
            <h3 class="text-base md:text-lg font-extrabold text-slate-900 border-l-4 border-indigo-600 pl-3.5 uppercase tracking-wider mb-6">SKILLS & COMPETENCIES</h3>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
                
                <!-- Card 1: Technical Skill -->
                <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-indigo-500/30 relative overflow-hidden group hover:border-indigo-500/60 transition-all duration-500 flex flex-col justify-between">
                    <div class="absolute -top-16 -right-16 w-52 h-52 bg-indigo-600/20 rounded-full blur-3xl pointer-events-none group-hover:bg-indigo-600/30 transition-all duration-500"></div>
                    
                    <div>
                        <!-- Header -->
                        <div class="flex items-center gap-4 mb-6 pb-4 border-b border-slate-800/80">
                            <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-white shadow-lg shadow-indigo-500/30 text-2xl font-black shrink-0">
                                📊
                            </div>
                            <div>
                                <span class="text-[11px] font-black text-indigo-400 uppercase tracking-widest block mb-0.5">Data & Analytics</span>
                        ...
                        <div class="space-y-3.5 text-sm">
                            ...
                            <div class="bg-slate-800/70 rounded-2xl p-4 border border-slate-700/60 hover:bg-slate-800 transition-all">
                                <div class="font-extrabold text-indigo-300 mb-1 flex items-center gap-2 text-xs md:text-sm">
                                    <span class="w-2 h-2 rounded-full bg-indigo-400 shadow-sm shadow-indigo-400"></span> Excel
                                </div>
                ...
                <div class="space-y-7 flex flex-col justify-between">
                    ...
                    <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-sky-500/30 relative overflow-hidden group hover:border-sky-500/60 transition-all duration-500">
                        ...
                        <div class="flex flex-wrap gap-2.5 text-xs font-bold text-sky-200">
                            ...
                            <span class="px-3.5 py-2 bg-sky-950/80 text-sky-200 hover:bg-sky-500/20 hover:text-white border border-sky-500/30 rounded-xl transition-all flex items-center gap-2 shadow-sm"><span class="w-1.5 h-1.5 rounded-full bg-indigo-400"></span> REST API (Basic)</span>
