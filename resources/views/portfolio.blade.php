            ...
            <div class="w-full md:w-1/2 flex justify-center relative gs-reveal-up" style="transition-delay: 200ms;">
                ...
                <div data-tilt data-tilt-max="15" data-tilt-speed="400" data-tilt-perspective="1000" class="relative w-[85%] max-w-[280px] sm:max-w-[320px] md:max-w-[360px] aspect-[4/5] rounded-[2.5rem] bg-gradient-to-br from-brand-blue via-brand-yellow to-brand-blue p-1.5 shadow-2xl shadow-sky-300/50 group cursor-pointer transform transition-transform duration-500">
                    ...
                    <div class="w-full h-full rounded-[2.3rem] overflow-hidden bg-slate-100 relative">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-sky-900/40 via-transparent to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
    ...
    <div class="max-w-6xl mx-auto px-6 relative z-10">
        <div class="text-center mb-16 gs-reveal-up">
            <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900">
                About <span class="bg-gradient-to-r from-sky-500 to-sky-500 bg-clip-text text-transparent">Me.</span>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 gs-reveal-up">
            ...
            <div class="md:col-span-2 bg-white p-8 md:p-12 rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 relative overflow-hidden group">
                ...
                <div class="absolute -right-4 -top-8 text-[180px] text-sky-50/50 font-serif leading-none group-hover:scale-110 group-hover:-rotate-6 transition-transform duration-700 pointer-events-none">"</div>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="flex-1 bg-gradient-to-br from-sky-500 to-purple-600 p-8 rounded-[2rem] shadow-lg shadow-sky-200 text-white transform hover:-translate-y-2 transition-transform duration-300 flex flex-col justify-center relative overflow-hidden group">
                    ...
                    <div class="flex items-center gap-3 mb-2 relative z-10">
                        <span class="relative flex h-4 w-4">
                          ...
                          <span class="relative inline-flex rounded-full h-4 w-4 bg-green-500 border-2 border-sky-600"></span>
                        </span>
                        <h4 class="text-sm font-bold uppercase tracking-widest text-sky-200">Current Status</h4>
                    </div>
                    <div class="text-3xl font-black mb-2 relative z-10 leading-tight">Open to<br>Work</div>
                    <p class="text-sky-100 font-medium relative z-10 mt-1 text-sm leading-relaxed">Seeking full-time roles in Data Science or Web Development.</p>
                </div>
                <!-- Box 2: Education -->
...
<section id="certifications" class="py-24 bg-slate-900 text-white relative overflow-hidden">
    <!-- Dekorasi -->
    <div class="absolute left-1/4 top-0 w-[500px] h-[500px] bg-gradient-to-br from-sky-500/20 to-transparent rounded-full blur-3xl -z-10"></div>
    ...
    <div class="max-w-6xl mx-auto px-6 gs-reveal-up text-center mb-16">
        <h2 class="text-4xl md:text-5xl font-extrabold mb-4">Licenses & <span class="bg-gradient-to-r from-sky-400 to-sky-400 bg-clip-text text-transparent">Certifications.</span></h2>
...
<section id="experience" class="py-32 bg-slate-50 relative overflow-hidden">
    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="w-full text-center mb-24 gs-reveal-up">
            <h2 class="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">Experience & <span class="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-sky-500">Impact.</span></h2>
        ...
        <div class="relative w-full max-w-4xl mx-auto">
            ...
            <div class="absolute left-[39px] md:left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-sky-500 via-sky-400 to-slate-200 transform md:-translate-x-1/2 rounded-full z-0"></div>
            ...
            <div class="relative flex flex-col md:flex-row items-center justify-between mb-16 md:mb-24 gs-reveal-up group">
                ...
                <div class="w-full md:w-[45%] pl-[80px] md:pl-12 text-left relative z-10">
                    <div class="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 transform group-hover:-translate-y-2 hover:shadow-2xl hover:shadow-sky-100 transition-all duration-300 relative overflow-hidden">
                        <div class="absolute top-0 right-0 w-20 h-20 bg-sky-50 rounded-bl-[100px] -z-10"></div>
                    ...
                    <div class="absolute inset-0 bg-{{ $project['color'] }}-900/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col sm:flex-row items-center justify-center gap-3 backdrop-blur-[2px]">
                        ...
                        @foreach($project['links'] as $link)
                            ...
                            @elseif($link['type'] == 'download')
                                <a href="{{ $link['url'] }}" download onclick="event.stopPropagation();" class="bg-sky-600 text-white font-bold px-4 py-2 rounded-full transform translate-y-8 group-hover:translate-y-0 transition-all duration-300 shadow-xl shadow-black/20 hover:bg-sky-700 hover:scale-105 flex items-center gap-2" title="{{ $link['text'] }}">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-10" onclick="closeCvModal()">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center pb-6 border-b border-slate-200 mb-8 sticky -top-6 bg-white/95 backdrop-blur-sm z-20 gap-4 py-2">
            ...
            <div class="flex items-center gap-3 self-end sm:self-auto">
                <a href="https://drive.google.com/drive/folders/1jDHvvCxNlffiIC0-Napk9JMO77F5cjl6?usp=sharing" target="_blank" class="px-4 py-2 bg-sky-600 text-white font-bold text-sm rounded-xl hover:bg-sky-700 transition-all flex items-center gap-2 shadow-sm" title="Unduh arsip dari Google Drive jika dibutuhkan">
        ...
        <div class="mb-10">
            <h3 class="text-base md:text-lg font-extrabold text-slate-900 border-l-4 border-sky-600 pl-3.5 uppercase tracking-wider mb-6">PROFESSIONAL EXPERIENCE</h3>
            
            <!-- Exp 1 -->
            <div class="border-l-2 border-sky-500 pl-5 md:pl-6 pb-6 mb-6 border-b border-slate-100">
            ...
            <!-- Exp 2 -->
            <div class="border-l-2 border-sky-500 pl-5 md:pl-6 pb-2">
        ...
        <!-- SKILLS -->
        <div>
            <h3 class="text-base md:text-lg font-extrabold text-slate-900 border-l-4 border-sky-600 pl-3.5 uppercase tracking-wider mb-6">SKILLS & COMPETENCIES</h3>
            
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-7">
                
                <!-- Card 1: Technical Skill -->
                <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-sky-500/30 relative overflow-hidden group hover:border-sky-500/60 transition-all duration-500 flex flex-col justify-between">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4 mb-6 pb-4 border-b border-slate-800/80">
                            ...
                            <div>
                                <span class="text-[11px] font-black text-sky-400 uppercase tracking-widest block mb-0.5">Data & Analytics</span>
                        ...
                        <div class="space-y-3.5 text-sm">
                            ...
                            <div class="bg-slate-800/70 rounded-2xl p-4 border border-slate-700/60 hover:bg-slate-800 transition-all">
                                <div class="font-extrabold text-sky-300 mb-1 flex items-center gap-2 text-xs md:text-sm">
                                    <span class="w-2 h-2 rounded-full bg-sky-400 shadow-sm shadow-sky-400"></span> Excel
                                </div>
                ...
                <div class="space-y-7 flex flex-col justify-between">
                    ...
                    <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-emerald-500/30 relative overflow-hidden group hover:border-emerald-500/60 transition-all duration-500">
                        ...
                        <div class="flex items-center gap-4 mb-5 pb-3.5 border-b border-slate-800/80">
                            <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white shadow-lg shadow-emerald-500/30 text-2xl font-black shrink-0">
                                💻
                            </div>
                            <div>
                    ...
                    <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-sky-500/30 relative overflow-hidden group hover:border-sky-500/60 transition-all duration-500">
                        ...
                        <div class="flex flex-wrap gap-2.5 text-xs font-bold text-sky-200">
                            ...
                            <span class="px-3.5 py-2 bg-sky-950/80 text-sky-200 hover:bg-sky-500/20 hover:text-white border border-sky-500/30 rounded-xl transition-all flex items-center gap-2 shadow-sm"><span class="w-1.5 h-1.5 rounded-full bg-sky-400"></span> REST API (Basic)</span>
                    ...
                    <div class="bg-slate-900 text-white rounded-3xl p-6 md:p-8 shadow-2xl border border-amber-500/30 relative overflow-hidden group hover:border-amber-500/60 transition-all duration-500">
                        ...
                        <!-- Header -->
                        <div class="flex items-center gap-4 mb-5 pb-3.5 border-b border-slate-800/80">
                            <div class="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white shadow-lg shadow-amber-500/30 text-2xl font-black shrink-0">
                                🔥
                            </div>
                            <div>
...
<section id="contact" class="py-20 bg-white relative">
    <div class="max-w-xl mx-auto px-6 gs-reveal-up">
        ...
        <div class="bg-gradient-to-br from-white to-slate-50 p-6 md:p-8 rounded-3xl shadow-2xl shadow-sky-100/50 border border-slate-100 flex justify-center">
